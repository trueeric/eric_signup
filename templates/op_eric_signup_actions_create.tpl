...
<form action="index.php" method="post" id="myForm" enctype="multipart/form-data" class="form-horizontal">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10">
            <input type="text" name="end_date" id="end_date" class="form-control validate[requird]" value="<{$end_date}>" placeholder="請輸入報名截止日期" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss' , startDate:'%y-%M-%d %H:%m:%s}' , minDate:'%y-%M-{%d+2}  %H:%m:%s'})">
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10">
            <input type="text" name="action_date" id="action_date" class="form-control validate[requird]" value="<{$action_date}>" placeholder="請輸入活動日期" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss' , startDate:'%y-%M-%d %H:%m:%s}' , minDate:'%y-%M-{%d-1}  %H:%m:%s'})">
        </div>
    </div>
    <div class="form-group row">
        <label class="col-sm-2 control-label col-form-label text-md-right">
